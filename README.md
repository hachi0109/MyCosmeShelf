...
# 利用方法
## 1. ユーザー登録
トップページの「新規登録」から、ニックネーム・メールアドレス・パスワード・お好みのテーマカラーを入力して登録
します。
...
# 画面遷移図
[![Image from Gyazo](https://i.gyazo.com/119d8e99f69443c9eefb153bb97b1224.png)](https://gyazo.com/119d8e99f69443c9eefb153bb97b1224)
